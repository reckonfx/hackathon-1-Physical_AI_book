...
if (typeof window !== 'undefined') {
  ...
  API_BASE_URL = 'http://localhost:8000'; // Update this to your deployed backend URL

  // Temporary change to trigger rebuild - v2
  console.log('ChatWidget API config loaded - v2');
} else {
